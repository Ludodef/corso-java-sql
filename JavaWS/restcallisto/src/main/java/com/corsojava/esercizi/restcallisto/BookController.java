...
public class BookController {
	...
	public ResponseEntity<DataWrapper<List<Book>>> getAuthor(@PathVariable String author){
	...
	public ResponseEntity<DataWrapper<List<Book>>> getTitle(@PathVariable String title){
	...
	@PutMapping("/{id}")
	public ResponseEntity<DataWrapper<Book>> edit(@PathVariable Long id ,@RequestBody Book b){
		b.setId(id);
		if(bs.edit(b) == null) {
